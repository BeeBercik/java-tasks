package generics.automatSorting;

import java.util.ArrayList;
import java.util.Collections;

// w tym rozwiazaniu sortedlist to nie tylko klasa glowna a funkcja main, a klasa ktorej bedziemy tworzyc egzemplarze, dlatego mamy typ generyczny T - mozna tworzyc obiekt tej klasy o roznych typach elementow do sortowania (wlasnie dlateo\go nalezy zaznaczyc przy klasie SortedList ze typ gen. T to beda elementy impl. interf. Comparable - inaczej Collections.sort() nie wie czy bedzie w stanie je sortowac.
...
// dzieki typowi generycznemu T moge tworzyc rozne obiekty tej klasy o roznych typachelementow w liscie. Dzieki temu jedna ogolna klasa list pozwala stworzyc dwie listy przechowujace dwa rozne typy elementow (dodatkowe ograniczenie ze nasz typ T musi rozszerzac Comparable, aby metoda Collections.sort() wiedziala jakiego typu elementy bedzie sortowac)
