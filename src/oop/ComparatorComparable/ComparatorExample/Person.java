package oop.ComparatorComparable.ComparatorExample;

import java.util.Arrays;
import java.util.Comparator;

// bardziej elastyczny od comparable, bo nie definiujemy domyslnej metody sortowania dla obiektow, a przekazujemy OBIEKT COMPARATORA, ktory wskazuje w jkai sposob ma sortowac jakies elementy
// mozna stworzyc kilka implementacji comparatora i przekazac ktory sie chce, kiedy comparable w obiekcie na stale okresla w jaki spososb go porownywac z innymi
...
public class Person {
    ...
    public static void main(String[] args) {
        ...
        Person.sort(array, new SurnameComparator());
